 ...
 */
package com.mycompany.mavenproject1.controller.util;
...
public class ValidationUtil {
    ...
    public static String getResponse(javax.mvc.binding.BindingResult validationResult, com.mycompany.mavenproject1.controller.util.ErrorBean error) {
