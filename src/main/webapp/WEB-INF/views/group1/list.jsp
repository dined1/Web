            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                    ...
                                    <c:forEach items="${GROUP_1_LIST}" var="GROUP_1">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="confirm_delete_${GROUP_1.groupId}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <c:if test="${empty requestScope.GROUP_1_LIST}">
