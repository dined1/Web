            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-6"><h5><i class="fa fa-database fa-fw"></i> <b> Paymenttype List</b></h5></div>
                            <div class="col-lg-6">
                                <div align="right">
                                    <a class="btn btn-primary btn-sm" href="new"><i class="fa fa-plus"></i> Add</a>
                                    <c:if test="${not empty requestScope.PAYMENTTYPE_LIST}">
                                        <button class="btn btn-default btn-sm" onclick="javascript:window.print()">
                                            <i class="fa fa-print fa-fw"></i> Print Paymenttype list
                                        </button>
                                    </c:if>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="PAYMENTTYPE_TABLE">
                                <thead>
                                    <tr>
                                        <th>PTId</th>
                                        <th>Type Name</th>
                                    ...
                                    <c:forEach items="${PAYMENTTYPE_LIST}" var="PAYMENTTYPE">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="confirm_delete_${PAYMENTTYPE.PTId}" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <c:if test="${empty requestScope.PAYMENTTYPE_LIST}">
                            <div class="alert alert-info">
                                <div align="center">No Paymenttype found</div>
                            </div>
                        </c:if>
