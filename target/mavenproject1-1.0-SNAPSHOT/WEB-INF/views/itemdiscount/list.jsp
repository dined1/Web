                            ...
                            <table class="table table-striped table-bordered table-hover" id="ITEMDISCOUNT_TABLE">
                                ...
                                <tbody>
                                    <c:forEach items="${ITEMDISCOUNT_LIST}" var="ITEMDISCOUNT">
                                        <tr>
                                            <td>${mvc.encoders.html(ITEMDISCOUNT.IDid)}</td>
                                                ...
                                                <div class="pull-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right" role="menu">
                                                            ...
                                                            <li><a href="${appPath}/itemdiscount/update/${ITEMDISCOUNT.IDid}"><i class="fa fa-edit fa-fw"></i>  Edit</a></li>
                                                            <li class="divider"></li>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="${appPath}/itemdiscount/remove/${ITEMDISCOUNT.IDid}" method="DELETE">
