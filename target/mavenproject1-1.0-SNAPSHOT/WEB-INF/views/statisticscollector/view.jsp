                                ...
                                <div class="list-group">
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">${mvc.encoders.html(STATISTICSCOLLECTOR.SCId)}</div>
                                        </div>
                                    </a>             
                                    <a href="#" class="list-group-item">
                                        <div class="row">
                                            <div class="col-lg-4"><span class="small">Statistic Type :</span></div>
                                            <div class="col-lg-8">${mvc.encoders.html(STATISTICSCOLLECTOR.statisticType)}</div>
                                        </div>
                                    </a>             
                                    <a href="#" class="list-group-item">
                                        <div class="row">
                                            <div class="col-lg-4"><span class="small">Statistics Info :</span></div>
                                            <div class="col-lg-8">${mvc.encoders.html(STATISTICSCOLLECTOR.statisticsInfo)}</div>
                                        </div>
                                    </a>             
